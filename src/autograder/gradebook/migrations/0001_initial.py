...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('submission_name', models.CharField(help_text='Enter your name and the name of the assignment you are submitting.', max_length=160)),
                ('submission_file', models.FileField(upload_to='submissions/', validators=[gradebook.validators.validate_file])),
                ('assignment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='gradebook.Assignment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('line_description', models.CharField(help_text='Write a brief description of the project.', max_length=60, unique=True)),
                ...
                ('assignment_list', models.ManyToManyField(help_text='What assignments are under this project?', to='gradebook.Assignment')),
            ],
        ),
    ]
